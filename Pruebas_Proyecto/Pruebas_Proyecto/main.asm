...
VERIFICAR_ESTADO_5:
    ...
    brne VERIFICAR_ESTADO_7
    ; En estado alarma, los botones UP/DOWN controlan si está activa o no
    ; El control de activación se maneja en MOSTRAR_ALARMA
    rjmp FIN_LEER_BOTONES
    
VERIFICAR_ESTADO_7:
    cpi r19, ESTADO_EDITAR_ALARMA_HORA
    brne VERIFICAR_ESTADO_8
    
    ; Estado 7: editar hora de alarma
    sbrc r18, BOTON_UP
    rcall INCREMENTAR_ALARMA_HORA
    
    sbrc r18, BOTON_DOWN

    rcall DECREMENTAR_ALARMA_HORA
    rjmp FIN_LEER_BOTONES
    
VERIFICAR_ESTADO_8:
    cpi r19, ESTADO_EDITAR_ALARMA_MIN
    brne FIN_LEER_BOTONES
    
    ; Estado 8: editar minutos de alarma
    sbrc r18, BOTON_UP
    rcall INCREMENTAR_ALARMA_MIN
    
    sbrc r18, BOTON_DOWN
    rcall DECREMENTAR_ALARMA_MIN
...
CAMBIAR_MODO:
    lds r16, estado_actual
    inc r16
    cpi r16, 6    ; Ahora tenemos 6 estados (0, 1, 2, 3, 4, 5)
    brlt GUARDAR_ESTADO
    ldi r16, 0    ; Volver al estado 0
    
GUARDAR_ESTADO:
    sts estado_actual, r16
    rcall ACTUALIZAR_LEDS_ESTADO  ; Actualizar los LEDs de estado
    ret
